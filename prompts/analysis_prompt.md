...
> [Üçüncü cümle: ne arıyor + profili kimin görmesini istiyor]"

### Eklenecek Beceriler (Skills Bölümü)
İş ilanından çıkan, LinkedIn Beceriler bölümüne eklenmesi gereken 3-5 anahtar kelime — recruiter filtreleri bu kelimeleri tarıyor. Listeyi düz yaz, koşullu ifade kullanma ("eğer biliyorsan", "varsa" gibi eklemeler yasak — beceriyi ya yaz ya yazma):
- [Beceri 1]
- [Beceri 2]
- [Beceri 3]
(varsa devam)
...
Bu pozisyona başvuruyorsan mülakatta karşılaşabileceğin 5 soru. Her soruyu iş ilanının gereksinimlerine ve CV'deki gerçek profile dayandır — genel sorular değil, bu pozisyon ve bu aday için özel sorular.
...
4. **[Soru]** — *Neden sorulabilir:* [...]
5. **[Soru]** — *Neden sorulabilir:* [...]

### Hazırlanma İpucu:
Bu sorulardan hangisi seni en çok zorlayacak? O konuda şu an ne bildiğini ve ne öğrenmen gerektiğini düşün.
